...
unsafe fn create_swapchain_image_views(
    ...
    data.swapchain_image_views = data.swapchain_images.iter().map(|i| create_image_view(device, *i, data.swapchain_format, vk::ImageAspectFlags::COLOR)).collect::<Result<Vec<_>, _>>()?;
    Ok(())
}
